...
DEFAULT_SETTINGS: dict[str, dict[str, Any]] = {
    ...
    "ai": {
        ...
        "api_key": {"value": "", "type": "str", "secret": True,
                     "description": "OpenRouter (or any OpenAI-compatible) API key"},
        "base_url": {"value": "https://openrouter.ai/api/v1", "type": "str"},
    },
    "gmail": {
        "watch_pubsub": {"value": True, "type": "bool"},
        "transport": {"value": "auto", "type": "str",
                      "description": "auto | smtp | api | fake"},
        "client_id": {"value": "", "type": "str",
                       "description": "Google OAuth client ID"},
        "client_secret": {"value": "", "type": "str", "secret": True,
                           "description": "Google OAuth client secret"},
        "sender_email": {"value": "", "type": "str"},
        "sender_name": {"value": "", "type": "str"},
    },
    "smtp": {
        "host": {"value": "", "type": "str",
                  "description": "SMTP server (e.g. smtp.office365.com for Microsoft 365 / Outlook)"},
        "port": {"value": 587, "type": "int"},
        "username": {"value": "", "type": "str"},
        "password": {"value": "", "type": "str", "secret": True},
        "from_email": {"value": "", "type": "str",
                        "description": "Sender used for SMTP (defaults to username)"},
        "from_name": {"value": "", "type": "str"},
        "use_tls": {"value": True, "type": "bool",
                     "description": "STARTTLS on port 587"},
    },
    "telegram": {
        "bot_token": {"value": "", "type": "str", "secret": True,
                       "description": "Token from @BotFather"},
        "chat_id": {"value": "", "type": "str"},
    },
    "sending": {
